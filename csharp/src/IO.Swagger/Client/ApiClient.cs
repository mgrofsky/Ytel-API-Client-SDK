...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.message360.com/api/v3/");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.message360.com/api/v3/).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.message360.com/api/v3/")
        {
