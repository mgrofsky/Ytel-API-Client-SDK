#import "SWGCarrierApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGCarrierApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGCarrierApi

NSString* kSWGCarrierApiErrorDomain = @"SWGCarrierApiErrorDomain";
NSInteger kSWGCarrierApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) carrierLookupWithPhoneNumber: (NSString*) phoneNumber
    ...
    if (phoneNumber == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCarrierApiErrorDomain code:kSWGCarrierApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carrier/lookup.json"];
...
-(NSURLSessionTask*) carrierLookuplistWithPage: (NSNumber*) page
    ...
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/carrier/lookuplist.json"];
